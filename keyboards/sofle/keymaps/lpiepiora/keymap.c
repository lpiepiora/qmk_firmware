...
[_LOWER] = LAYOUT(
  ...
  _______, KC_EXLM,   KC_PERC, KC_HASH,  KC_UNDS, KC_CIRC,                       KC_DLR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RPRN, KC_PIPE,
 ...
 * |      |      |      |      |      |      |                    |      |      |      |      |      |      |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
 * | Esc  | Ins  | Pscr | Menu |      |      |                    | PgDn | PgUp | Home | End  | DLine| Bspc |
 * |------+------+------+------+------+------|                    |------+------+------+------+------+------|
...
[_RAISE] = LAYOUT(
  ...
  _______,  KC_INS,  KC_PSCR,   KC_APP,  XXXXXXX, XXXXXXX,                        KC_PGDN, KC_PGUP,   KC_HOME, KC_END,KC_DLINE, KC_BSPC,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    // default setting is for MacOS, so swap_lctl_lgui is the MacOS path
    switch (keycode) {
        case KC_QWERTY:
